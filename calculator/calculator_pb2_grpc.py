...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Square = channel.unary_unary(
                ...
                request_serializer=calculator__pb2.RpcInput.SerializeToString,
                response_deserializer=calculator__pb2.RpcOutput.FromString,
                )
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Square': grpc.unary_unary_rpc_method_handler(
                    servicer.Square,
                    request_deserializer=calculator__pb2.RpcInput.FromString,
                    response_serializer=calculator__pb2.RpcOutput.SerializeToString,
            ),
...
class Calculator(object):
    ...
    def Square(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/calculator.Calculator/Square',
            calculator__pb2.RpcInput.SerializeToString,
            calculator__pb2.RpcOutput.FromString,
